...
const TripSearch = (props: TripSearch) => {
  ...
  return (
    <form className={classNames(styles.form, className)} onSubmit={handleSubmit} {...rest}>
      <Magnifier className={styles.icon} />
      <input type="text" value={query} onChange={handleQueryUpdate} placeholder="Search flight number" />
